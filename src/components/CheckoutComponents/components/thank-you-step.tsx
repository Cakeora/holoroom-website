            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="relative h-16 w-16 flex-none rounded-lg bg-muted">
                  <img src="/placeholder.svg" alt="Modern Sofa" className="w-full h-full object-cover rounded-lg" />
                </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="relative h-16 w-16 flex-none rounded-lg bg-muted">
                  <img src="/placeholder.svg" alt="Coffee Table" className="w-full h-full object-cover rounded-lg" />
                </div>
                <div className="flex-1 min-w-0">
